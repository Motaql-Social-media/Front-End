    ...
    <div className="flex flex-1 flex-grow-[8] max-[540px]:mt-16">
      <div ref={profileRef} className="no-scrollbar ml-0 mr-1 w-full max-w-[620px] shrink-0 flex-grow overflow-y-scroll border border-b-0 border-t-0 border-lightBorder dark:border-darkBorder  max-[540px]:border-l-0 max-[540px]:border-r-0 sm:w-[600px]">
        ...
        <div className="border-b border-darkBorder">
          <div className="relative">
            ...
            <div className="">
              <img loading="lazy" onClick={() => openImageViewer(0)} alt="profile" className={`absolute -bottom-[75px] bg-black ${i18next.language === "en" ? "left-[5%]" : "right-[5%]"}  h-[150px] w-[150px] transform  cursor-pointer rounded-full border-4 border-black`} src={ imageUrl} />
            </div>
          </div>
          <div>
      ...
      {isViewerOpen && (
        <div className="z-[99]" dir="ltr">
          <ImageViewer disableScroll={true} src={[imageUrl, bannerUrl]} currentIndex={currentImage} closeOnClickOutside={true} onClose={closeImageViewer} />
        </div>
      )}
      {user && <Widgets />}
    </div>
