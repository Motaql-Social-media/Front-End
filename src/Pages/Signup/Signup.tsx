...
import ForthStep from "../../components/Signup/ForthStep"
import FifthStep from "../../components/Signup/FifthStep"
import TagStep from "../../components/Signup/TagStep"
import ErrorPage from "../../components/Signup/ErrorPage"
import PreStep from "../../components/Signup/PreStep"
import SixthStep from "../../components/Signup/SixthStep"

import CustomizedStepper from "../../components/Signup/CustomizedStepper"
      ...
      <Modal open={openModal} onClose={handleCloseModal} disableEscapeKeyDown disablePortal>
        <Box style={modalStyle} sx={{ overflow: "hidden" }}>
          <div className="relative h-full min-w-[350px] bg-white dark:bg-black md:rounded-2xl">
            ...
            <div dir="ltr" className={`max-s350:hidden`}>
            ...
            <FirstStep nickName={nickName} setNickName={setNickName} speciality={speciality} setSpeciality={setSpeciality} month={month} setMonth={setMonth} day={day} setDay={setDay} year={year} setYear={setYear} setPosition={setPosition} position={position} />
            <SecondStep nickName={nickName} phoneNumber={phoneNumber} setPhoneNumber={setPhoneNumber} setPosition={setPosition} position={position} />
            <ThirdStep nickName={nickName} phoneNumber={phoneNumber} setPosition={setPosition} position={position} />

            <ForthStep nickName={nickName} email={email} setEmail={setEmail} emailExistError={emailExistError} setEmailExistError={setEmailExistError} validEmail={validEmail} setPosition={setPosition} position={position} />
            <FifthStep nickName={nickName} email={email} setPosition={setPosition} position={position} />

            <SixthStep nickName={nickName} email={email} phoneNumber={phoneNumber} speciality={speciality} month={month} day={day} year={year} password={password} setPassword={setPassword} setUserToken={setUserToken} setUser={setUser} setOriginalUsername={setOriginalUsername} setPosition={setPosition} position={position} />

            <TagStep userTag={userTag} setUserTag={setUserTag} originalUsername={originalUsername} userToken={userToken} user={user} setUser={setUser} setPosition={setPosition} position={position} />
            <UploadProfilePicture userR={user} setUser={setUser} userToken={userToken} handleCompleteSignup={handleCompleteSignup} handleCloseModal={handleCloseModal} />
