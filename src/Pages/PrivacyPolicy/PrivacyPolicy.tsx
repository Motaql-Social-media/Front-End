    ...
    <div className="w-full overflow-y-scroll">
      ...
      <div className="md:w-[75%]">
        <div className="flex flex-col gap-2 p-5 ">
          <div className="mb-9 text-5xl font-bold text-primary md:text-6xl">{t("introduction")}</div>
        ...
        <div className="flex flex-col gap-2 p-5 ">
          <div className="mb-9 text-5xl font-bold text-primary md:text-6xl">{t("information_from_users")}</div>
        ...
        <div className="flex flex-col gap-2 p-5 ">
          <div className="mb-9 text-5xl font-bold text-primary md:text-6xl">{t("information_from_cookies")}</div>
          <div className="mb-4 text-3xl font-bold md:text-4xl">{t("information_from_cookies_text1")}</div>
          <div className={`${i18next.language === "en" ? "pl-8" : "pr-8"} text-gray-400`}>{t("information_from_cookies_text11")}</div>
          <div className="mb-4 text-3xl font-bold md:text-4xl">{t("information_from_cookies_text2")}</div>
        ...
        <div className="flex flex-col gap-2 p-5 ">
          <div className="mb-9 text-5xl font-bold text-primary md:text-6xl">{t("share_with_third_party")}</div>
          <ul className={`list-disc ${i18next.language === "en" ? "pl-12" : "pr-12"}`}>
        ...
        <div className="flex flex-col gap-2 p-5 ">
          <div className="mb-9 text-5xl font-bold text-primary md:text-6xl">{t("what_do_we_do_with_your_personal_information")}</div>
          <ul className={`list-disc ${i18next.language === "en" ? "pl-12" : "pr-12"}`}>
        ...
        <div className="flex flex-col gap-2 p-5 ">
          <div className="mb-9 text-5xl font-bold text-primary md:text-6xl">{t("protect_information")}</div>

          <div className={`${i18next.language === "en" ? "pl-8" : "pr-8"} my-2 text-gray-400`}>{t("protect_information_text")}</div>
        </div>
        <div className="flex flex-col gap-2 p-5 ">
          <div className="mb-9 text-5xl font-bold text-primary md:text-6xl">{t("control_over_your_information")}</div>
