...
const PostFooter = ({ id, replyCount, reposted, repostsNum, liked, likesNum }: { id: string; replyCount: number; reposted: boolean; repostsNum: number; liked: boolean; likesNum: number }) => {
  ...
  return (
    <div className="post-footer text-ternairy mt-3 flex w-full justify-around pl-12 dark:text-gray-500 ">
      ...
      <div className={`group pointer-events-auto flex cursor-pointer items-center transition-colors duration-300 ${reposted ? "text-green-500" : ""} hover:text-green-500`} title={t("repost")} onClick={handleRepostClick}>
      ...
      <div className={`group  pointer-events-auto flex cursor-pointer items-center transition-colors duration-300 ${liked ? "text-pink-600" : ""} hover:text-pink-600`} title={t("like")} onClick={handleLikeClick}>
      ...
      <div className="flex items-center justify-center ">
        ...
        <div className={`group pointer-events-auto flex cursor-pointer items-center transition-colors duration-300 hover:text-primary`} title={t("share")}>
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-inherit group-hover:bg-[#e7f5fd] dark:group-hover:bg-[#031018]">
