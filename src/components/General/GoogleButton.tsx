    ...
    <div>
      ...
      >
        <div className="relative flex items-center justify-center">
          <div className="absolute left-4 top-1/2 h-[40px] w-[40px] -translate-y-1/2 max-xs:w-6 max-[340px]:left-1">
          ...
          <div className="text-black max-xs:text-xs">{t("signin_google")}</div>
        </div>
      </button>
