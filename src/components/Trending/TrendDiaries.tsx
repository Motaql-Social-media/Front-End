...
const TrendDiaries = () => {
  ...
  useEffect(() => {
    API.get(`tweets/supporting/${query}`)
      .then((res) => {
  ...
  return (
    <div>
      ...
      {diaries.length === 0 && <div className="mt-10 text-center text-2xl font-bold text-primary">No diaries found</div>}
    </div>
  )
}

export default TrendDiaries
