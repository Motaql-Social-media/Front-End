...
import { Cake, CalendarMonth, LocationOn } from "@mui/icons-material"
...
const Profile = ({ scroll }: { scroll: number }) => {
  ...
  return (
    <div className="flex flex-1 flex-grow-[8] max-[540px]:mt-16">
      <div ref={profileRef} className="no-scrollbar ml-0 mr-1 w-full max-w-[620px] shrink-0 flex-grow overflow-y-scroll border border-b-0 border-t-0 border-lightBorder dark:border-darkBorder  max-[540px]:border-l-0 max-[540px]:border-r-0 sm:w-[600px]">
        ...
        <div className="border-b border-darkBorder">
          <div className="relative">
            <img alt="banner" className="h-[200px] w-full cursor-pointer" src={bannerUrl} loading="lazy" onClick={() => openImageViewer(1)} />
            <div>
          ...
          <div>
            ...
            <div className="p-5">
              ...
              <div className="py-3">{bio ? bio : "I am a passionate computer engineer with a strong desire to leverage technology to solve complex problems and create innovative solutions. I bring a blend of technical expertise and a collaborative spirit to every project I undertake."}</div>
      ...
      {isViewerOpen && (
        <div className="z-[99]">
          <ImageViewer disableScroll={true} src={[process.env.REACT_APP_USERS_MEDIA_URL + imageUrl, bannerUrl]} currentIndex={currentImage} closeOnClickOutside={true} onClose={closeImageViewer} />
        </div>
      )}
    </div>
  )
